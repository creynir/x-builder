...
export const apiErrorSchema = z.object({
  code: z.enum([
    ...
    "external_x_signals_add_failed",
    "external_x_signals_remove_failed",
    "external_x_signals_refresh_failed",
    "external_x_signals_overview_failed",
    "not_found",
    "internal_error",
  ]),
